...
R_charge = 4e-2  # Uniform charge radius [m]
...
ax0.plot(x_probes, E_r_thx, label='Analytic E-uniformly', color='green')
ax0.set_xlim([-R_cham-0.01, R_cham+0.01])
ax0.legend(loc='upper right')
ax0.set_ylabel('Ex on the x axis [V/m]')
ax0.set_title('FFT vs analytic: uniform charge')
